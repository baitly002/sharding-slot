...
//
//    private ShardingSphereDriver shardingSphereDriver;
//
...
//        // 以 HikariCP 为例
//        try {
//            this.getClass().getClassLoader().loadClass("org.apache.shardingsphere.driver.ShardingSphereDriver");
//        }catch (Exception e){
//            e.printStackTrace();
//        }
////        shardingSphereDriver = new ShardingSphereDriver();
